...
**ContentRegularExpression** | **string** | The content has to match the expression | [optional] [default to null]
**ContentNegativeRegularExpression** | **string** | The content cannot match the expression | [optional] [default to null]
